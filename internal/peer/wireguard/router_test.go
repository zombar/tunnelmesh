	...
	tests := []struct {
	...
	}{
		{
			...
			packet: []byte{
				...
				0xac, 0x1e, 0x00, 0x01, // source: 10.42.0.1
				0xac, 0x1e, 0x64, 0x01, // dest: 10.42.100.1
			},
			want:    "10.42.100.1",
			wantErr: false,
		},
	...
	tests := []struct {
	...
	}{
		{
			...
			packet: []byte{
				...
				0x00, 0x00, 0x00, 0x00,
				0x40, 0x06, 0x00, 0x00,
				0xac, 0x1e, 0x64, 0x01, // source: 10.42.100.1
				0xac, 0x1e, 0x00, 0x01, // dest: 10.42.0.1
			},
			want:    "10.42.100.1",
			wantErr: false,
		},
...
func TestRoutePacketDropNonWG(t *testing.T) {
	...
	packet := []byte{
		...
		0x40, 0x06, 0x00, 0x00,
		0xac, 0x1e, 0x00, 0x01, // source: 10.42.0.1
		0xac, 0x1e, 0x00, 0x02, // dest: 10.42.0.2 (not a WG client)
	}
