...
| --------- | ------- | --------- |
| Mesh CIDR | 10.42.0.0/16 | Full mesh network |
| Peer IPs | 10.42.0.1 - 10.42.99.255 | Native TunnelMesh peers |
| WG Clients | 10.42.100.0 - 10.42.255.255 | WireGuard clients |

**Example allocation:**

- Coordinator: 10.42.0.1
- Desktop peer: 10.42.0.5
- Server peer: 10.42.0.10
- WG Concentrator interface: 10.42.100.1
- iPhone (WG client): 10.42.100.2
- Android (WG client): 10.42.100.3
...
```text
iphone.tunnelmesh    -> 10.42.100.2
android.tunnelmesh   -> 10.42.100.3
laptop.tunnelmesh    -> 10.42.100.4
```
...
```ini
[Peer]
AllowedIPs = 10.42.0.0/16, 10.0.0.0/8, 192.168.1.0/24
```
...
ping 10.42.0.1  # Coordinator IP
dig @10.42.0.1 peer-name.tunnelmesh
```
